...
| HUD v2 "Flight Deck" | ✅ หน้าเว็บของเราเอง ไม่ใช่ของ upstream ที่โดนเจาะ · ถอยกลับ v1 ได้ |
| ตัวตรวจจับเสียงแยกเป็นโมดูล + เทสต์ | ✅ `host/hud/vad.js` · 10 เทสต์ ทุกตัวมาจากบั๊กจริง |
| กู้ไมค์เองเมื่อ AudioContext ถูกพัก | ✅ ไม่ต้องรีเฟรชอีก |
| แผนที่ / ดาวเทียม / เส้นทาง / สตรีทวิว | ✅ Maps Embed API · เอเจนต์เปิดเองได้ |
| "จากที่ผมอยู่ไป..." | ✅ ต้องเปิดผ่าน https |
| กล้อง → ให้เอเจนต์อ่านเอกสาร | ✅ **ทดสอบแล้ว** อ่านโบรชัวร์ไทยแล้วเปิดแผนที่ต่อเองได้ |
...
| เสียงอ้างอิงของจริง | ⏳ ตอนนี้ใช้เสียงตัวอย่างจากผู้พัฒนา F5-TTS-THAI — **เป็นเพดานของความชัด** ([ทำไม](docs/THAI-TTS.md)) |
| โลก 3 มิติ (Photorealistic) | ⏳ โค้ดพร้อม รอผูกบัญชีเรียกเก็บเงินกับ Google Cloud |
